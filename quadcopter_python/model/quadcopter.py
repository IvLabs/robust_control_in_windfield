...
class Quadcopter:
    ...
    def __init__(self, pos, attitude, wind):
    ...
    def update(self, dt, F, M):
        ...
        if self.wind_state:
            aerodynamic_forces,u,v = self.calc_aerodrags()
        else:
